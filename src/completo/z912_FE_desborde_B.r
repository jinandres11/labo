...
AgregarVariables  <- function( dataset )
{
  ...
  #variables creadas en funcion de  campos monetarios sobre la edad o la antiguedad 
  ...
  dataset[,  JIA_clie_antig_anio         := trunc(cliente_antiguedad / 12)] #antiguedad en a�os
  ...
  dataset[,  JIAinvers_sobre_prod     := cproductos / mpasivos_margen] #cant. prod sobre ganancia
